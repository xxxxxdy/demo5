<template>
    <div class="text">
        <div style="display:inline-block;">Window</div>
        <div style="display:inline-block; text-align: center; background-color: #2932FF; color:white; font-size: 16px; margin-left: 10px; width: 22px; height: 22px; 
         border-radius: 50%;">{{ identify }}</div>
    </div>
    ...
    <div @mouseenter="rollingForDetail" @mouseleave="rollingCancel">
        ...
        <button class="align" @click="alignAsBase"> Primary </button>
    </div>
