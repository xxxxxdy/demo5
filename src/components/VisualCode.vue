...
export default{
    ...
    methods:{
        ...
        /// interactive
        // highlightSender(){
        //     if(this.style_border["border"] === "2px solid white"){
        //         color_for_highlight[this.mapping] = getRandomColor()
        //         this.$emit('highlight', this.mapping)
        //     }
        //     else{
        //         delete(color_for_highlight[this.mapping])
        //         this.$emit('delete', this.mapping)
        //     }
        // },
        highlightReceiver(){
            // if(this.style_border["border"] === "2px solid white"){
            //     this.style_border["border"] = "2px solid " + color_for_highlight[this.mapping][0]
            // }
            // else{
            //     this.style_border["border"] = "2px solid white"
            // }
    ...
    watch:{
        mapping(new_value, old_value){
            if(new_value in color_for_highlight){
                this.style_border["border"] = "2px solid" + color_for_highlight[new_value][0]
            }
            else{
                this.style_border["border"] = "2px solid white"
            }
